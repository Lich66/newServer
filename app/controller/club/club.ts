...
export class Club {
    ...
    public static async createClub(json: IClubRequest): Promise<ITbl_club> {
    ...
    public static async deleteClub(json: IClubRequest) {
        return await tbl_club.destroy({ where: { ...json } });
    }
    public static async updateClub(njson: IClubRequest, ojson: IClubRequest) {
        return await tbl_club.update(njson, { where: { ...ojson } })
    }
    public static async getClub(json: IClubRequest): Promise<ITbl_club[]> {
