import {
    ITbl_account,
} from '../../interface/models/tbl_account';
import {
    tbl_account,
} from '../../models/tbl_account';
import {
    User,
} from '../user/user';
import {
...
import {
    tbl_user,
} from '../../models/tbl_user';
import {
    IUserResponse,
    IUserinfoRequest,
    IAccountInfoRequest,
    ITokenInfoRequest,
} from '../../interface/user/remote/userInterface';
import {
    ITbl_user,
} from '../../interface/models/tbl_user';
import {
    defaultUser,
} from '../../gameConfig/defaultUser';
